...
const blockedMiddleware = require('./Adminpannle/graphql/middleware'); // Middleware to check if user is blocked
...
const adminTypeDefs = require('./Adminpannle/graphql/typedef');
const adminResolvers = require('./Adminpannle/graphql/resolver');
...
// Use middleware to check if user is blocked before allowing access to protected routes
