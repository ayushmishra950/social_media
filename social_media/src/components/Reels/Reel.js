      ...
      >
        <div className="relative w-full h-full bg-black">
          ...
          <video
            ...
            preload="metadata"
            controls={false}
            onLoadStart={() => /* console.log(...) */ void 0}
            onLoadedMetadata={() => /* console.log(...) */ void 0}
            onLoadedData={() => /* console.log(...) */ void 0}
            onCanPlay={() => /* console.log(...) */ void 0}
            onPlay={() => {
              if (offset === 0) {
                setIsVideoPlaying(true);
                if (hasUserInteracted) {
        ...
        <div className="flex-1 md:ml-64 relative">
          ...
          <div className="fixed inset-0 flex items-center justify-center z-10 bg-gray-50">
            <div className="w-full max-w-[19.6875rem] mx-auto flex flex-col items-center justify-center py-8">
              ...
              {!loading && !videosLoading && allVideos.length === 0 && (
